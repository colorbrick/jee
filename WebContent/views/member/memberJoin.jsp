						...
						<fieldset>
                            ...
                            <div class="input-box">
                                ...
                                <dl>
                                    ...
                                    <dd>
                                        <input name="Id" title="가입 아이디" class="input-box id_txt" id="Id" type="text" value="" placeholder="아이디를 입력하세요." >
                                        <a class="button h30 w85 white " id="aPopId" href="#" target=""><b>중복확인</b></a>
                                    </dd>
                                </dl>
                                <div class="line-e2e2e2"></div>
                                <dl>
                                    ...
                                    <dd>
                                        <input name="Password" title="비밀번호" class="input-box" id="Password" type="password">
                                    </dd>
                                    <dd>
                                        <p>
